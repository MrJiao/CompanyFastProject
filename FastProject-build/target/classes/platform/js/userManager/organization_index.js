	...
	self.model = ( function () { 
		...
		return {
			...
			add : function(){
				...
				//console.log("页面输入内容为:"+name+"---"+orgCode+"---"+pxNum+"---"+remark);
		  ...
		  /**
			...
			*/
			...
			addRoleToOrg : function( rolesList ){
				...
				// console.log("选中的角色ids:"+roleIds);
				// console.log("当前机构id:"+currentId);
				jQuery.ajax({
					type: "POST",
			...
			assignOrg : function () {
				...
				//console.log("组织的id数组:"+orgIdArray);
