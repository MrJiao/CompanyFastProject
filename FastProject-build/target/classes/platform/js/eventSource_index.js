...
//					console.log("类型: "+typeof value);	console.log(value);	console.log(rows.id);
...
//        	console.log("当前表: "+left.rowData);
//        	console.log("当前数据库: "+id);
//        	console.log("当前数据库: "+middle.dbId);
...
//				console.log("新增后:"+middle.columnArray);
...
//				console.log("删除后:"+middle.columnArray);
			}
		},
...
//				console.log("去重前: "+ middle.columnArray);
				//同样, 别忘了去重
